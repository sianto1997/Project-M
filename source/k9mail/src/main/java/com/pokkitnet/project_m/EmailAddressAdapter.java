...
public class EmailAddressAdapter extends ResourceCursorAdapter {
    ...
    public EmailAddressAdapter(Context context) {
        super(context, com.pokkitnet.project_m.R.layout.recipient_dropdown_item, null);
    ...
    public final void bindView(final View view, final Context context, final Cursor cursor) {
        final TextView text1 = (TextView) view.findViewById(com.pokkitnet.project_m.R.id.text1);
        final TextView text2 = (TextView) view.findViewById(com.pokkitnet.project_m.R.id.text2);
