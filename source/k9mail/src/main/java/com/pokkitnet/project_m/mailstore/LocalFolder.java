...
import com.pokkitnet.project_m.activity.Search;
...
import com.pokkitnet.project_m.mail.filter.CountingOutputStream;
...
import com.pokkitnet.project_m.mail.message.MessageHeaderParser;
import com.pokkitnet.project_m.mailstore.LockableDatabase.DbCallback;
import com.pokkitnet.project_m.mailstore.LockableDatabase.WrappedException;
...
public class LocalFolder extends Folder<LocalMessage> implements Serializable {
     ...
     * {@link com.pokkitnet.project_m.controller.MessagingController#shouldNotifyForMessage} to see if messages being
