...
import com.pokkitnet.project_m.Account.DeletePolicy;
import com.pokkitnet.project_m.Account.Expunge;
import com.pokkitnet.project_m.AccountStats;
import com.pokkitnet.project_m.K9;
import com.pokkitnet.project_m.K9.Intents;
import com.pokkitnet.project_m.K9.NotificationHideSubject;
import com.pokkitnet.project_m.K9.NotificationQuickDelete;
import com.pokkitnet.project_m.NotificationSetting;
...
import com.pokkitnet.project_m.activity.FolderList;
import com.pokkitnet.project_m.activity.MessageList;
import com.pokkitnet.project_m.activity.MessageReference;
import com.pokkitnet.project_m.activity.NotificationDeleteConfirmation;
import com.pokkitnet.project_m.activity.setup.AccountSetupCheckSettings.CheckDirection;
import com.pokkitnet.project_m.activity.setup.AccountSetupIncoming;
import com.pokkitnet.project_m.activity.setup.AccountSetupOutgoing;
import com.pokkitnet.project_m.cache.EmailProviderCache;
import com.pokkitnet.project_m.helper.Contacts;
import com.pokkitnet.project_m.helper.MessageHelper;
import com.pokkitnet.project_m.mail.Address;
import com.pokkitnet.project_m.mail.CertificateValidationException;
import com.pokkitnet.project_m.mail.FetchProfile;
import com.pokkitnet.project_m.mail.Flag;
import com.pokkitnet.project_m.mail.Folder;
import com.pokkitnet.project_m.mail.Folder.FolderType;
import com.pokkitnet.project_m.mail.Message;
import com.pokkitnet.project_m.mail.Message.RecipientType;
import com.pokkitnet.project_m.mail.MessageRetrievalListener;
...
import com.pokkitnet.project_m.mail.Pusher;
...
import com.pokkitnet.project_m.mail.internet.MimeUtility;
...
import com.pokkitnet.project_m.mailstore.LocalStore.PendingCommand;
import com.pokkitnet.project_m.mailstore.MessageRemovalListener;
import com.pokkitnet.project_m.mailstore.UnavailableStorageException;
import com.pokkitnet.project_m.provider.EmailProvider;
import com.pokkitnet.project_m.provider.EmailProvider.StatsColumns;
import com.pokkitnet.project_m.search.ConditionsTreeNode;
...
import com.pokkitnet.project_m.search.SqlQueryBuilder;
import com.pokkitnet.project_m.service.NotificationActionService;
...
public class MessagingController implements Runnable {
    ...
    private static class NotificationData {
         ...
         * Don't modify this list directly, but use {@link #addMessage(com.pokkitnet.project_m.mailstore.LocalMessage)} and
         * {@link #removeMatchingMessage(android.content.Context, com.pokkitnet.project_m.activity.MessageReference)} instead.
         */
    ...
    private void configureLockScreenNotification(NotificationCompat.Builder builder,
        ...
        builder.setSmallIcon(R.drawable.ic_notify_new_mail);
        builder.setColor(R.color.project_m_yellow);

        NotificationCompat.Builder publicNotification = new NotificationCompat.Builder(context);
        publicNotification.setSmallIcon(R.drawable.ic_notify_new_mail);
        publicNotification.setColor(R.color.project_m_yellow);
