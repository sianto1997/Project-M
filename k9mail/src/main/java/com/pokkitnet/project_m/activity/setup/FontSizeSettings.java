...
public class FontSizeSettings extends K9PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.pokkitnet.project_m.R.xml.font_preferences);
        ...
        final String summaryFormat = getString(com.pokkitnet.project_m.R.string.font_size_message_view_content_summary);
        final String titleFormat = getString(com.pokkitnet.project_m.R.string.font_size_message_view_content_dialog_title);
