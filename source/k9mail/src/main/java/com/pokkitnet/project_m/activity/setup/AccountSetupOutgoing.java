...
public class AccountSetupOutgoing extends K9Activity implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pokkitnet.project_m.R.layout.account_setup_outgoing);
        ...
        mRequireLoginView = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.account_require_login);
        mRequireLoginSettingsView = (ViewGroup)findViewById(com.pokkitnet.project_m.R.id.account_require_login_settings);
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText = getString(com.pokkitnet.project_m.R.string.account_setup_outgoing_invalid_setting_combo_notice,
