...
import com.pokkitnet.project_m.mail.filter.FixedLengthInputStream;
...
import static com.pokkitnet.project_m.mail.K9MailLib.PUSH_WAKE_LOCK_TIMEOUT;
...
public class ImapStore extends RemoteStore {
     ...
     *
     * @see com.pokkitnet.project_m.mail.store.StoreConfig#getStoreUri()
