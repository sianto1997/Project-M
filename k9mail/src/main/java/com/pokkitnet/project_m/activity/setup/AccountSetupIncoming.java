...
import com.pokkitnet.project_m.*;
import com.pokkitnet.project_m.Account.FolderMode;
import com.pokkitnet.project_m.mail.NetworkType;
import com.pokkitnet.project_m.activity.K9Activity;
import com.pokkitnet.project_m.activity.setup.AccountSetupCheckSettings.CheckDirection;
import com.pokkitnet.project_m.helper.Utility;
...
import com.pokkitnet.project_m.mail.store.imap.ImapStore.ImapStoreSettings;
import com.pokkitnet.project_m.mail.store.webdav.WebDavStore.WebDavStoreSettings;
import com.pokkitnet.project_m.account.AccountCreator;
import com.pokkitnet.project_m.service.MailService;
import com.pokkitnet.project_m.view.ClientCertificateSpinner;
import com.pokkitnet.project_m.view.ClientCertificateSpinner.OnClientCertificateChangedListener;
...
public class AccountSetupIncoming extends K9Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pokkitnet.project_m.R.layout.account_setup_incoming);

        mUsernameView = (EditText)findViewById(com.pokkitnet.project_m.R.id.account_username);
        mPasswordView = (EditText)findViewById(com.pokkitnet.project_m.R.id.account_password);
        mClientCertificateSpinner = (ClientCertificateSpinner)findViewById(com.pokkitnet.project_m.R.id.account_client_certificate_spinner);
        mClientCertificateLabelView = (TextView)findViewById(com.pokkitnet.project_m.R.id.account_client_certificate_label);
        mPasswordLabelView = (TextView)findViewById(com.pokkitnet.project_m.R.id.account_password_label);
        TextView serverLabelView = (TextView) findViewById(com.pokkitnet.project_m.R.id.account_server_label);
        mServerView = (EditText)findViewById(com.pokkitnet.project_m.R.id.account_server);
        mPortView = (EditText)findViewById(com.pokkitnet.project_m.R.id.account_port);
        mSecurityTypeView = (Spinner)findViewById(com.pokkitnet.project_m.R.id.account_security_type);
        mAuthTypeView = (Spinner)findViewById(com.pokkitnet.project_m.R.id.account_auth_type);
        mImapAutoDetectNamespaceView = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.imap_autodetect_namespace);
        mImapPathPrefixView = (EditText)findViewById(com.pokkitnet.project_m.R.id.imap_path_prefix);
        mWebdavPathPrefixView = (EditText)findViewById(com.pokkitnet.project_m.R.id.webdav_path_prefix);
        mWebdavAuthPathView = (EditText)findViewById(com.pokkitnet.project_m.R.id.webdav_auth_path);
        mWebdavMailboxPathView = (EditText)findViewById(com.pokkitnet.project_m.R.id.webdav_mailbox_path);
        mNextButton = (Button)findViewById(com.pokkitnet.project_m.R.id.next);
        mCompressionMobile = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.compression_mobile);
        mCompressionWifi = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.compression_wifi);
        mCompressionOther = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.compression_other);
        mSubscribedFoldersOnly = (CheckBox)findViewById(com.pokkitnet.project_m.R.id.subscribed_folders_only);
        ...
        try {
            ...
            if (Type.POP3 == settings.type) {
                serverLabelView.setText(com.pokkitnet.project_m.R.string.account_setup_incoming_pop_server_label);
                findViewById(com.pokkitnet.project_m.R.id.imap_path_prefix_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.webdav_advanced_header).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.webdav_mailbox_alias_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.webdav_owa_path_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.webdav_auth_path_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.compression_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.compression_label).setVisibility(View.GONE);
                mSubscribedFoldersOnly.setVisibility(View.GONE);
            } else if (Type.IMAP == settings.type) {
                serverLabelView.setText(com.pokkitnet.project_m.R.string.account_setup_incoming_imap_server_label);
                ...
                if (!editSettings) {
                    findViewById(com.pokkitnet.project_m.R.id.imap_folder_setup_section).setVisibility(View.GONE);
                }
            } else if (Type.WebDAV == settings.type) {
                serverLabelView.setText(com.pokkitnet.project_m.R.string.account_setup_incoming_webdav_server_label);
                ...
                findViewById(com.pokkitnet.project_m.R.id.imap_path_prefix_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.account_auth_type_label).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.account_auth_type).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.compression_section).setVisibility(View.GONE);
                findViewById(com.pokkitnet.project_m.R.id.compression_label).setVisibility(View.GONE);
                mSubscribedFoldersOnly.setVisibility(View.GONE);
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText = getString(com.pokkitnet.project_m.R.string.account_setup_incoming_invalid_setting_combo_notice,
                    getString(com.pokkitnet.project_m.R.string.account_setup_incoming_auth_type_label),
                    AuthType.EXTERNAL.toString(),
                    getString(com.pokkitnet.project_m.R.string.account_setup_incoming_security_label),
    ...
    public void onClick(View v) {
        try {
            switch (v.getId()) {
            case com.pokkitnet.project_m.R.id.next:
                onNext();
                break;
            }
        } catch (Exception e) {
    ...
    private void failure(Exception use) {
        ...
        String toastText = getString(com.pokkitnet.project_m.R.string.account_setup_bad_uri, use.getMessage());
