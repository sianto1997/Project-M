...
import com.pokkitnet.project_m.activity.MessageCompose;
import com.pokkitnet.project_m.activity.UpgradeDatabases;
...
import com.pokkitnet.project_m.mail.internet.BinaryTempFileBody;
import com.pokkitnet.project_m.mailstore.LocalStore;
import com.pokkitnet.project_m.provider.UnreadWidgetProvider;
import com.pokkitnet.project_m.mail.ssl.LocalKeyStore;
import com.pokkitnet.project_m.service.BootReceiver;
import com.pokkitnet.project_m.service.MailService;
import com.pokkitnet.project_m.service.ShutdownReceiver;
import com.pokkitnet.project_m.service.StorageGoneReceiver;
...
public class K9 extends Application {
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(com.pokkitnet.project_m.K9.ApplicationAware)} will
     * immediately call {@link com.pokkitnet.project_m.K9.ApplicationAware#initializeComponent(K9)} for the
     * supplied argument.
     */
    ...
    public static class Intents {
        ...
        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.pokkitnet.project_m.intent.extra.FROM")
     ...
     * {@link com.pokkitnet.project_m.preferences.GlobalSettings}, too.
     *
    ...
    public static int getK9ThemeResourceId(Theme themeId) {
        return (themeId == Theme.LIGHT) ? com.pokkitnet.project_m.R.style.Theme_K9_Light : com.pokkitnet.project_m.R.style.Theme_K9_Dark;
    }
