...
import com.pokkitnet.project_m.fragment.ConfirmationDialogFragment;
import com.pokkitnet.project_m.fragment.ConfirmationDialogFragment.ConfirmationDialogFragmentListener;
import com.pokkitnet.project_m.mail.AuthenticationFailedException;
import com.pokkitnet.project_m.mail.CertificateValidationException;
...
import com.pokkitnet.project_m.mail.filter.Hex;
...
public class AccountSetupCheckSettings extends K9Activity implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pokkitnet.project_m.R.layout.account_setup_check_settings);
        mMessageView = (TextView)findViewById(com.pokkitnet.project_m.R.id.message);
        mProgressBar = (ProgressBar)findViewById(com.pokkitnet.project_m.R.id.progress);
        findViewById(com.pokkitnet.project_m.R.id.cancel).setOnClickListener(this);

        setMessage(com.pokkitnet.project_m.R.string.account_setup_check_settings_retr_info_msg);
    ...
    private void handleCertificateValidationException(CertificateValidationException cve) {
        ...
        if (chain != null) {
            acceptKeyDialog(
                    com.pokkitnet.project_m.R.string.account_setup_failed_dlg_certificate_message_fmt,
                    cve);
        } else {
            showErrorDialog(
                    com.pokkitnet.project_m.R.string.account_setup_failed_dlg_server_message_fmt,
    ...
    private void acceptKeyDialog(final int msgResId, final CertificateValidationException ex) {
        mHandler.post(new Runnable() {
            public void run() {
                ...
                .setTitle(getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_invalid_certificate_title))
                ...
                .setCancelable(true)
                .setPositiveButton(
                    getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_invalid_certificate_accept),
                ...
                .setNegativeButton(
                    getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_invalid_certificate_reject),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
    ...
    private void onCancel() {
        mCanceled = true;
        setMessage(com.pokkitnet.project_m.R.string.account_setup_check_settings_canceling_msg);
    }

    public void onClick(View v) {
        switch (v.getId()) {
        case com.pokkitnet.project_m.R.id.cancel:
            onCancel();
            break;
        }
    }
    ...
    private void showErrorDialog(final int msgResId, final Object... args) {
        mHandler.post(new Runnable() {
            public void run() {
                showDialogFragment(com.pokkitnet.project_m.R.id.dialog_account_setup_error, getString(msgResId, args));
            }
        });
    }
    ...
    private void showDialogFragment(int dialogId, String customMessage) {
        ...
        switch (dialogId) {
            case com.pokkitnet.project_m.R.id.dialog_account_setup_error: {
                fragment = ConfirmationDialogFragment.newInstance(dialogId,
                        getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_title),
                        customMessage,
                        getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_edit_details_action),
                        getString(com.pokkitnet.project_m.R.string.account_setup_failed_dlg_continue_action)
                );
                break;
            }
            default: {
    ...
    private String errorMessageForCertificateException(CertificateValidationException e) {
        switch (e.getReason()) {
            case Expired: return getString(com.pokkitnet.project_m.R.string.client_certificate_expired, e.getAlias(), e.getMessage());
            case MissingCapability: return getString(com.pokkitnet.project_m.R.string.auth_external_error);
            case RetrievalFailure: return getString(com.pokkitnet.project_m.R.string.client_certificate_retrieval_failure, e.getAlias());
    ...
    private class CheckAccountTask extends AsyncTask<CheckDirection, Integer, Void> {
        ...
        protected Void doInBackground(CheckDirection... params) {
            ...
            try {
                ...
                showErrorDialog(
                        com.pokkitnet.project_m.R.string.account_setup_failed_dlg_auth_message_fmt,
        ...
        private void checkOutgoing() throws MessagingException {
            if (!(account.getRemoteStore() instanceof WebDavStore)) {
                publishProgress(com.pokkitnet.project_m.R.string.account_setup_check_settings_check_outgoing_msg);
            }
        ...
        private void checkIncoming() throws MessagingException {
            ...
            if (store instanceof WebDavStore) {
                publishProgress(com.pokkitnet.project_m.R.string.account_setup_check_settings_authenticate);
            } else {
                publishProgress(com.pokkitnet.project_m.R.string.account_setup_check_settings_check_incoming_msg);
            }
            store.checkSettings();

            if (store instanceof WebDavStore) {
                publishProgress(com.pokkitnet.project_m.R.string.account_setup_check_settings_fetch);
            }
